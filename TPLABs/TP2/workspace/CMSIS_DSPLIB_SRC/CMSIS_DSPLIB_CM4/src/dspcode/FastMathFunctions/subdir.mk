...
src/dspcode/FastMathFunctions/%.o: ../src/dspcode/FastMathFunctions/%.c src/dspcode/FastMathFunctions/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-dspcode-2f-FastMathFunctions

clean-src-2f-dspcode-2f-FastMathFunctions:
	-$(RM) ./src/dspcode/FastMathFunctions/arm_cos_f32.d ./src/dspcode/FastMathFunctions/arm_cos_f32.o ./src/dspcode/FastMathFunctions/arm_cos_q15.d ./src/dspcode/FastMathFunctions/arm_cos_q15.o ./src/dspcode/FastMathFunctions/arm_cos_q31.d ./src/dspcode/FastMathFunctions/arm_cos_q31.o ./src/dspcode/FastMathFunctions/arm_sin_f32.d ./src/dspcode/FastMathFunctions/arm_sin_f32.o ./src/dspcode/FastMathFunctions/arm_sin_q15.d ./src/dspcode/FastMathFunctions/arm_sin_q15.o ./src/dspcode/FastMathFunctions/arm_sin_q31.d ./src/dspcode/FastMathFunctions/arm_sin_q31.o ./src/dspcode/FastMathFunctions/arm_sqrt_q15.d ./src/dspcode/FastMathFunctions/arm_sqrt_q15.o ./src/dspcode/FastMathFunctions/arm_sqrt_q31.d ./src/dspcode/FastMathFunctions/arm_sqrt_q31.o

.PHONY: clean-src-2f-dspcode-2f-FastMathFunctions
